...
knitr::opts_knit$set(base.url = "https://raw.githubusercontent.com/brownag/soilprofilecollection/main/")
```
...
Once we have `DataFrame`s containing site and horizon data, we instantiate the `SoilProfileCollection` object using the constructor:
